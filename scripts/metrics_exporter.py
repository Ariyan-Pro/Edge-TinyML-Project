...
class MetricsExporter:
    ...
    def update_system_metrics(self):
        memory = psutil.virtual_memory()  # FIXED: Define memory variable
...
if __name__ == '__main__':
    exporter = metrics_exporter.start_metrics_server()
    try:
        while True:
            exporter.record_kws_latency(3.64)
            exporter.record_wakeword_detection('yes')
            time.sleep(10)
